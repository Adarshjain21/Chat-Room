...
const AfterLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-400 via-blue-200 to-blue-50 p-3 sm:p-6 flex gap-5">
      <div className={`w-full lg:w-[50%] lg:max-w-[500px] ${!basePath && "hidden"} lg:block`}>
      <Sidebar user={user}/>
      </div>
...
<div className={`hidden ${!basePath ? "hidden" : "lg:block"} w-full h-[93vh]`}>
      <Box
      sx={{
        background: "rgba(255, 255, 255, 0.7)", // light glass effect
        borderRadius: "16px",
    ...
    >
      <div className={`h-full flex-col items-center justify-center p-6 hidden ${!basePath ? "hidden" : "lg:flex" }`}>
          ...
          <h1 className="text-3xl font-semibold mt-6">Welcome to Chat Room</h1>
          <p className="text-gray-400 mt-2 text-center">
            Connect, chat, and share experiences with people around the world in
            our Chat Room.
          </p>
